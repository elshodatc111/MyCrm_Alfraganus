...
class AdminGuruhController extends Controller{
    ...
    public function boshSoatlar($dars_vaqti){
        ...
        foreach($dars_vaqti as $teme){
            switch ($teme) {
                case 1:
                    $Mavjud_vaqtlar['1']['text'] = '08:00-10:00';
                    $Mavjud_vaqtlar['1']['id'] = 1;
                    break;
                case 2:
                    $Mavjud_vaqtlar['2']['text'] = '10:00-12:00';
                    $Mavjud_vaqtlar['2']['id'] = 2;
                    break;
                case 3:
                    $Mavjud_vaqtlar['3']['text'] = '12:00-14:00';
                    $Mavjud_vaqtlar['3']['id'] = 3;
                break;
                case 4:
                    $Mavjud_vaqtlar['4']['text'] = '14:00-16:00';
                    $Mavjud_vaqtlar['4']['id'] = 4;
                    break;
                case 5:
                    $Mavjud_vaqtlar['5']['text'] = '16:00-18:00';
                    $Mavjud_vaqtlar['5']['id'] = 5;
                    break;
                case 6:
                    $Mavjud_vaqtlar['6']['text'] = '18:30-20:00';
                    $Mavjud_vaqtlar['6']['id'] = 6;
                    break;
                case 7:
                    $Mavjud_vaqtlar['7']['text'] = '20:00-22:00';
    ...
    public function CreateGuruh1(Request $request){
        ...
        $dars_vaqti = array(1,2,3,4,5,6,7);
    ...
    public function GuruhAbout($id){ 
        ...
        switch ($Guruhlar->guruh_vaqt) {
            case 1:
                $Guruh['guruh_vaqt'] = '08:00-10:00';
                break;
            case 2:
                $Guruh['guruh_vaqt'] = '10:00-12:00';
                break;
            case 3:
                $Guruh['guruh_vaqt'] = '12:00-14:00';
            break;
            case 4:
                $Guruh['guruh_vaqt'] = '14:00-16:00';
                break;
            case 5:
                $Guruh['guruh_vaqt'] = '16:00-18:00';
                break;
            case 6:
                $Guruh['guruh_vaqt'] = '18:00-20:00';
                break;
            case 7:
                $Guruh['guruh_vaqt'] = '20:00-21:00';
                break;
            case 8:
        }
